package com.ming.bns.admin.utils.consoletable;

import com.ming.bns.admin.utils.consoletable.enums.Align;
import com.ming.bns.admin.utils.consoletable.enums.NullPolicy;
import com.ming.bns.admin.utils.consoletable.table.Body;
import com.ming.bns.admin.utils.consoletable.table.Cell;
import com.ming.bns.admin.utils.consoletable.table.Header;
import com.ming.bns.admin.utils.consoletable.util.StringPadUtil;
    ...
    public static void main(String[] args){
        ...
        List<List<Cell>> body = new ArrayList<List<Cell>>(){{
            add(new ArrayList<Cell>(){{
                add(new Cell("kat"));
                add(new Cell(Align.LEFT,"kat@gimal.com"));
                add(new Cell(Align.LEFT,"54321"));
            }});
            add(new ArrayList<Cell>(){{
                add(new Cell("ashe"));
                add(new Cell(Align.LEFT,"ashe_111@hotmail.com"));
                add(new Cell(Align.RIGHT,"9876543中文测试210"));
            }});
            add(new ArrayList<Cell>(){{
                add(null);
                add(new Cell(null));
